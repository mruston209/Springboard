...
-- A2:
4 facilities: Badminton Court, Table Tennis, Snooker Table, and Pool Table
...
-- A7:
SELECT DISTINCT name AS courtname, CONCAT_WS(' ', firstname, surname) AS membername
FROM Bookings
LEFT JOIN Facilities
ON Bookings.facid = Facilities.facid
LEFT JOIN Members
ON Members.memid = Bookings.memid
WHERE (name LIKE 'Tennis%') AND (surname != 'GUEST')
ORDER BY membername
